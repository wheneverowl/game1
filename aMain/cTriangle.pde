class Triangle {
  public float px = 0;        // point (set by mouse)
  public float py = 0;
  public float Mid1X = 0;
  public float Mid2X = 0;
  public float Mid3X = 0;
  public float Mid1Y = 0;
  public float Mid2Y = 0;
  public float Mid3Y = 0;
  ...
  public void collideTriangle() {
    ...
    this.Intercepts[5]=this.y3-Slope[5]*this.x3;
